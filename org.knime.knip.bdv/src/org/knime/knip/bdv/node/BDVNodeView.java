...
// * Zinsmaier</a>
// */
// public class BDVNodeView<T extends RealType<T>, L extends Comparable<L>, I
/// extends IntegerType<I>>
...
//
// private Ui<AffineTransform3D,
/// InteractiveDisplayCanvasComponent<AffineTransform3D>> m_imgView = null;
//
// /* Current row */
// private int m_row;
//
...
// final Thread t = new Thread(r, "Segment Overlay Viewer-Updater-" +
...
//
// try {
// final ImgLabelingValue<L> currentLabelingCell = (ImgLabelingValue<L>)
/// m_tableContentView.getContentModel()
// .getValueAt(row, 1);
// final ImgPlus<T> imgPlus = ((ImgPlusValue<T>)
/// m_tableContentView.getContentModel().getValueAt(row, 0))
// .getImgPlus();
//
...
// final double[] scales = getcalib((AnnotatedSpace<? extends LinearAxis>)
/// imgPlus);
...
// final RealARGBConverter<T> converter = new
/// RealARGBConverter<T>(type.getMinValue(), type.getMaxValue());
//
// final InterpolatingSource<T, AffineTransform3D> renderSource = new
/// InterpolatingSource<T, AffineTransform3D>(
// source, sourceTransform, converter);
//
// boolean init = m_imgView == null;
//
// m_imgView = new Ui<AffineTransform3D,
...
// }
//
// private static double[] getcalib(final AnnotatedSpace<? extends LinearAxis>
/// calib) {
