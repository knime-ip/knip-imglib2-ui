...
/// NodeLogger.getLogger(BDVNodeModel.class);
//
// private ClearableTableContentModel m_contentModel;
//
// private final SettingsModelString m_imgCol = new
/// SettingsModelString(CFG_IMG_COL, "");
//
// private final SettingsModelString m_labelingCol = new
/// SettingsModelString(CFG_LABELING_COL, "");
//
...
// */
// @Override
// protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws
/// InvalidSettingsException {
//
// if (m_labelingCol.getStringValue() != null) {
// NodeUtils.autoColumnSelection(inSpecs[0], m_labelingCol, LabelingValue.class,
/// this.getClass());
// }
//
// if (m_imgCol.getStringValue() == null || m_imgCol.getStringValue().length()
/// == 0) {
...
// */
// @Override
// protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final
...
/// == 0) {
// imgColIdx =
/// NodeUtils.autoOptionalColumnSelection(inData[0].getDataTableSpec(),
/// m_imgCol,
// ImgPlusValue.class);
// } else {
// imgColIdx =
/// NodeUtils.silentOptionalAutoColumnSelection(inData[0].getDataTableSpec(),
/// m_imgCol,
// ImgPlusValue.class);
// }
//
...
// if (m_labelingCol.getStringValue() != null) {
// labelingColIdx = NodeUtils.autoColumnSelection(inData[0].getDataTableSpec(),
/// m_labelingCol,
// LabelingValue.class, this.getClass());
// }
//
// DataTableSpec spec = new DataTableSpec(DataTableSpec.createColumnSpecs(new
/// String[] { "Image", "Labeling" },
// new DataType[] { ImgPlusCell.TYPE, LabelingValue.TYPE }));
//
...
// if (imgColIdx != -1) {
// // check compatibility
// long[] labelingDims = ((ImgLabelingValue<L>) labCell).getDimensions();
// long[] imageDims = ((ImgPlusValue<T>) imgCell).getDimensions();
//
// if (labelingDims.length != imageDims.length) {
// setWarningMessage(
// "The number of dimensions of some labelings and images. Rows have been
/// skipped!");
...
// setWarningMessage(
// "Some labelings and images do not have compatible sizes and have been
/// skipped! Use the 'Virtually extend'-option to overcome this problem.");
...
// */
// @Override
// protected void loadInternals(final File nodeInternDir, final ExecutionMonitor
/// exec)
...
// */
// @Override
// protected void saveInternals(final File nodeInternDir, final ExecutionMonitor
/// exec)
// throws IOException, CanceledExecutionException {
// //
// }
...
// */
// @Override
// protected void validateSettings(final NodeSettingsRO settings) throws
/// InvalidSettingsException {
